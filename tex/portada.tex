\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=west, font=\cabin\LARGE, text=white] at ([xshift=-5.51\outermarginwidth, yshift=-2.2\covershift]current page.center) {Antonio M. Mendoza ~$\bullet$~ Luis A. Godínez};
    %%%%% LOGO %%%%%
    \node[anchor=west] at ([xshift=3.25\outermarginwidth, yshift=-2.2\covershift]current page.center) {\includegraphics[width=3.5cm]{Images/Portada/LOGO.pdf}};
\end{tikzpicture}
...
~\vfill\hfill\begin{minipage}[l]{0.67\textwidth}
