\begin{tikzpicture}[remember picture,overlay]
    ...
    %%%%%% LETRAS %%%%%
    \node[anchor=south,right] at ([xshift=-5.5\outermarginwidth, yshift=-.456\paperheight]current page.north) {\selectfont           \color{white}\cabin\bfseries\fontsize{95}{95}\selectfont ÁLGEBRA};
